...
const ProductDetailPage = () => {
  ...
  return (
    <div className="mx-auto px-4 py-8 bg-white dark:bg-cornsilk-d1">
      <Toaster richColors />
      ...
      {galleryOpen && (
        <div className="fixed inset-0 bg-zinc-100 bg-opacity-90 z-50 flex items-center justify-center">
          <div className="relative w-full h-full flex flex-col touch-none bg-white dark:bg-cornsilk-d1 text-black dark:text-white overflow-hidden">
            {/* Gallery Toolbar */}
