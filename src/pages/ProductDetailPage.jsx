...
const ProductDetailPage = () => {
  ...
  return (
    <div className='mx-auto px-2.5 py-4 md:px-4 md:py-8 bg-white dark:bg-cornsilk-d1'>
      ...
      {galleryOpen && (
        <div className='fixed inset-0 bg-white dark:bg-cornsilk-d1 z-50 flex items-center justify-center'>
          <div className='relative w-full h-full flex flex-col touch-none text-black dark:text-white overflow-hidden'>
            ...
            <div className={`p-4 flex items-center ${
              product.images > 0 ? 'justify-between' : 'justify-center'
            }`}>
              {product.images > 0 && (
                <button
                  onClick={goToPreviousImage}
                  className='p-1.5 md:p-3 rounded-full bg-black/50 bg-opacity-50 hover:bg-opacity-70 text-white transition'
