  ...
  <div className='flex items-center border dark:border-white/25 p-1.5 md:p-2 space-x-4'>
    ...
    <div className='w-full'>
      ...
      <div className='flex items-center space-x-3 mt-2'>
          ...
          <AlertDialog>
            <AlertDialogTrigger asChild>
              <Button
                size='icon'
                variant='destructive'
                className='size-7.5 md:size-9 bg-red-400 dark:bg-red-600 hover:ring-2 hover:ring-offset-1 hover:ring-red-400 hover:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500'
              >
                <X />
              </Button>
            </AlertDialogTrigger>
        ...
        <Button
          className='size-7.5 md:size-9 hover:bg-stone-200 hover:ring hover:ring-offset-1 hover:ring-white/25 focus:ring-2 focus:ring-offset-2 focus:ring-white/50 disabled:opacity-50 disabled:cursor-not-allowed'
          size='icon'
          variant='ghost'
