  ...
  return (
    ...
    >
      ...
      >
        ...
        {open && (
          <div className="flex items-center gap-2 max-md:w-full overflow-hidden">
            <Search
              size={20}
      ...
      {showResults && query.length > 0 && (
        <div className="absolute right-0 md:left-0 mt-1 w-80 max-md:w-full max-md:right-0 bg-white dark:bg-cornsilk-dark rounded shadow-lg border border-neutral-200 dark:border-neutral-700 max-h-72 overflow-y-auto z-50">
          {isSearching ? (
